...
namespace NeuroSky.MindView {
    public partial class Launcher : Form {
        ...
        public event ReplayLoadData.DisplayRecordDelegate ReplayEvent;
        ...
        void OnReplayButtonClicked(object sender, EventArgs e)
        {
            ...
            ReplayLoadData rep = new ReplayLoadData();

            //NeuroSky.MindView.ReplayLoadData.DisplayRecordDelegate dele = new ReplayLoadData.DisplayRecordDelegate(rep.DisplayRecord);
            //IAsyncResult asyncResult1 = dele.BeginInvoke(loadedList, this, null, dele);
            //dele.EndInvoke(asyncResult1);

            rep.LocalList = loadedList;
            rep.Sender = this;
            thrd = new System.Threading.Thread(new System.Threading.ThreadStart(rep.DisplayRecord));
            thrd.Start();
        }
